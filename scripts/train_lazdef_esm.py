# Trains LazDEF-ESM through MLM on LazDEF data
...
# SAVE LazDEF-ESM embs
np.save('./LazBF_mlm_LazDEF.npy', LazBF_embs)
np.save('./LazDEF_mlm_LazDEF.npy', LazDEF_embs)